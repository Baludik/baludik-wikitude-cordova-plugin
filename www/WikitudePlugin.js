 ...
 *                                      	}
 *                               	}
 * @param {boolean}						toBack				set Wikitude view on back
 */
  ...
  cordova.exec(successCallback, errorCallback, "WikitudePlugin", "open", [
    {
      ...
      toBack: toBack ? toBack : false
    }
  ]);

  if (
    cordova.platformId == "android" &&
    this.customBackButtonCallback == null
  ) {
    cordova.exec(
      this.onBackButton,
...
WikitudePlugin.prototype.setBackButtonCallback = function(
  ...
  if (cordova.platformId == "android") {
    ...
    alert(
      "setBackButtonCallback is only available on Android and not on" +
        cordova.platformId
    );
  }
};
