...
NSString * const kWTWikitudePlugin_ArgumentToBack                   = @"toBack";
...
+ (Boolean)requiredToBackFromString:(NSString *)string
{
...
- (void)open:(CDVInvokedUrlCommand *)command
{
    ...
    if ( self.isDeviceSupported && command.arguments.count )
    {
        ...
        if ( [argumentDictionary isKindOfClass:[NSDictionary class]] )
        {
            ...
            Boolean toBack = [WTWikitudePlugin requiredToBackFromString:[arguments objectForKey:kWTWikitudePlugin_ArgumentToBack]];
...
#pragma clang diagnostic pop
            ...
            if (toBack == true) {
              ...
              [self.viewController.view.superview addSubview:self.arViewController.view];
              [self.viewController.view.superview bringSubviewToFront:self.viewController.view];
            } else {
