...
//						this.cordova.getThreadPool().execute(
    ...
    private void loadArchitectWorld() {
        ...
        try {
            ...
            final Boolean toBack = params.getBoolean("toBack");
            ...
            this.cordova.getActivity().runOnUiThread( new Runnable() {
                ...
                public void run() {
                    try {
                        WikitudePlugin.this.addArchitectView( apiKey, filePath, features, startupConfiguration, toBack);
                    } catch ( Exception e ) {
     ...
     * @param toBack set Wikitude view on back
     * @throws IOException might be thrown from ARchitect-SDK
     */
    private void addArchitectView( final String apiKey, String filePath, int features, JSONObject startupConfiguration, final Boolean toBack) throws IOException {
        if ( this.architectView == null ) {
            this._toBack = toBack;
            WikitudePlugin.releaseFocusInCordovaWebView(cordova.getActivity().getWindow().getDecorView().findViewById(android.R.id.content));
            ...
            this.architectView = new ArchitectViewPhoneGap( this.cordova.getActivity() , new OnKeyUpDownListener() {
                ...
                public boolean onKeyUp(int keyCode, KeyEvent event) {
                    if (toBack == false && architectView!=null && keyCode == KeyEvent.KEYCODE_BACK) {
